...
<body>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="row">
								...
								<div class="col-md-4">
									<img src="uploads/logo.png" alt="logo" class="header-logo" class="img-responsive">
								</div>
								<div class="col-md-4">
									<div class="row header-lienhe">
										<i class="fas fa-envelope"> lienhe@fgc.vn</i>
										<i class="fas fa-phone">   ( +84 ) 45678910</i>	
									</div>
								</div>
							</div>
						</div>
	...
	<div class="menu">
		...
		<div class="slide">
			<div class="container-fluid container-flui-slide">
				<div class="row sanpham-chobe">
					<img src="uploads/banner_About.jpg" alt="" class="img-responsive">
				</div>
			</div>
		</div>
		<!-- ket thuc slide -->
				...
				<div class="container">
					<div class="row">
						<div class="col-md-3 footer-col1">
							...
							<img src="uploads/bocongthuong.png" alt="" class="img-responsive">
						</div>
						...
						<div class="row">
							<div class="col-md-12 footer-form-layout">
								<div class="footer-form-layout-col1">
									...
									<p>Hãy gửi yêu cầu cho chúng tôi sẽ giải đáp, tư vấn những sản phẩm tốt nhất cho bạn.</p>
								</div>
								<form action="" method="">
									<table>
									<tr>
										<td>
											<div  class="footer-form-layout-col2">
											<p>Họ và tên:</p>
										...
										<td>
											<div  class="footer-form-layout-col3">
											<p>Yêu cầu:</p>
											<textarea name="" cols="40" rows="7"></textarea>
